...
public class OnSetFormValue extends BasicEvent
{
  ...
  public OnSetFormValue(XTextDocument doc, String id, String value, ActionListener listener)
  {
    this.doc = doc;
    this.id = id;
    this.value = value;
  ...
  protected void doit() throws WollMuxFehlerException
  {
    ...
    if (formModel != null)
    {
      ...
      formModel.setValue(id, value, new ActionListener()
      {
        ...
        {
          WollMuxEventHandler.handleSetFormValueFinished(listener);
        }
      });
    } else
    {
  ...
  {
    return this.getClass().getSimpleName() + "(#" + doc.hashCode() + ", id='" + id + "', value='" + value + "')";
  }
}