 ...
 * PALChangeEventListener in die Liste der registrierten PALChangeEventListener
 * im WollMuxSingleton aufgenommen wird.
 * 
...
public class OnAddPALChangeEventListener extends BasicEvent
{
  ...
  public OnAddPALChangeEventListener(XPALChangeEventListener listener, Integer wollmuxConfHashCode)
  {
