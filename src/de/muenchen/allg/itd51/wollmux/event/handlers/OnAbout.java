...
public class OnAbout extends BasicEvent
{
  ...
  private final URL WM_URL = this.getClass().getClassLoader().getResource("data/wollmux_klein.jpg");
  ...
  protected void doit() throws WollMuxFehlerException
  {
    ...
    final JDialog dialog = new JDialog((Frame) null, L.m("Info über Vorlagen und Formulare (WollMux)"), false);
